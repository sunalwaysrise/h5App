...
<link rel="apple-touch-icon-precomposed" sizes="114x114" href="http://res.cp2y.com/h5/res/images/114.png?v=2014031901" />
<link rel="apple-touch-icon-precomposed" sizes="72x72" href="http://res.cp2y.com/h5/res/images/72.png?v=2014031901" />
<meta name="apple-mobile-web-app-status-bar-style" content="black" />
<link type="text/css" rel="stylesheet" href="http://res.cp2y.com/h5/res/css/css.css?v=2014031901"/>
</head>
<body>
<section id="mainSection" class="jc">
	...
	<div id="MainStep2">
		...
		<div class="totalMsg">
			...
			<div class="tools2 tools3"><a id="bets">0</a>注，<a id="money">0</a>元<br/>理论奖金:<a id="PrizeCalc"></a></div>
...
<div id="leagueChoose" class="jc">
	<div id="lcs"></div>
    <div id="lcs2"><a class="on" onclick="cp2y.buy.Lea2(this,1)">全选</a><a onclick="cp2y.buy.Lea2(this,2)">反选</a><a onclick="cp2y.buy.Lea2(this,3)">清空</a><a onclick="cp2y.buy.Lea2(this,4)">五大联赛</a></div>
	<div class="totalMsg">
		<div class="tools1" onclick="cp2y.buy.hideLC();">取消筛选</div>
		<a class="toolsBtn" onclick="cp2y.buy.Lea();">确认</a>
	</div>
</div>
<div id="loading"><div><a></a></div></div>
<div id="userUtil"></div>
<script src="http://res.cp2y.com/h5/res/js/zepto.min.js?v=2014031901"></script>
<script src="http://res.cp2y.com/h5/res/js/base.js?v=2014031901"></script>
<script src="http://res.cp2y.com/h5/res/js/userUtil.js?v=2014031901"></script>
<script src="http://res.cp2y.com/h5/res/js/play/10059.js?v=2014031901"></script>
<script src="http://res.cp2y.com/h5/res/js/jcBuy.js?v=2014031901"></script>
