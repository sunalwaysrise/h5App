...
$("#mainSection").show();
var jcDom={
	headerS1:$("#headerS1"),headerS2:$("#headerS2"),Title:$("#Title"),QRTi:$("#Title2"),changePlayType:$("#changePlayType"),
	jcTo:$("#jcTo"),jcTime:$("#jcTime"),choose:$("#choose"),MainStep1:$("#MainStep1"),MainStep2:$("#MainStep2"),curBets:$("#curBets"),
	curMoney:$("#curMoney"),betList:$("#betList"),Edit:$("#EditBets"),money:$("#money"),bets:$("#bets"),mul:$("#mul")
};
cp2y.buy={
	init:function(play){
		if( play in _ ){
	...
	getBall:function(){
		return jcDom.choose.children('li');
	},
